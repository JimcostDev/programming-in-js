function createTaskPlanner() {
  // Empezamos con un array vacío, aquí almacenaremos las tareas
  let tasks = [];

  // retornamos las funciones que servirán para manipular el array
  return {
    ...
    getTasks() {
     ...
     // Para obtener las tareas pendientes o completadas simplemente las filtramos y retornamos el resultado
    getPendingTasks() {
