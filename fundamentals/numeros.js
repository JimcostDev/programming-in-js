...
console.log(typeof resultado); // Salida: 'number'
console.log(resultado); // Salida: 0.5

// Operaciones de incremento y decremento
let vidas = 3;
vidas -= 1; // Equivalente a vidas = vidas - 1
console.log(vidas); // Salida: 2
